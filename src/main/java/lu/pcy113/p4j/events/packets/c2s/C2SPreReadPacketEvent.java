...
public class C2SPreReadPacketEvent implements PreReadPacketEvent, C2SReadPacketEvent, P4JServerEvent {
	...
	public C2SPreReadPacketEvent(ServerClient server, C2SPacket packet, ByteBuffer bb) {
		this.server = server;
		this.packet = packet;
		this.bb = bb;
	}
