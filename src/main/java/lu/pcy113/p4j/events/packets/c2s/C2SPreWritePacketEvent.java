...
public class C2SPreWritePacketEvent implements PreWritePacketEvent, C2SWritePacketEvent, P4JClientEvent {
	...
	public C2SPreWritePacketEvent(P4JClient client, C2SPacket packet, ByteBuffer bb) {
		this.client = client;
		this.packet = packet;
		this.bb = bb;
	}
